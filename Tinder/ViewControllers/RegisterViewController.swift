...
class RegisterViewController: UIViewController {
    ...
    private let alreadyHaveAcountButton = UIButton(type: .system).creatAboutAccountButton(text: "既にアカウントをお持ちの場合はこちら")
    ...
    private func setupLayout() {
        ...
        alreadyHaveAcountButton.anchor(top: baseStackView.bottomAnchor, centerX: view.centerXAnchor, topPadding: 20)
    }
    ...
    private func setupBindins() {
        ...
        alreadyHaveAcountButton.rx.tap
            .asDriver()
            .drive { [weak self] _ in
